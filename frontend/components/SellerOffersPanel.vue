...
<template>
  <section v-if="offers.length" class="panel space-y-5 p-4 sm:p-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
      ...
      <div class="w-fit rounded-2xl bg-slate-100 px-4 py-3 text-right">
    ...
    <div class="space-y-3">
      ...
      >
        <div class="flex items-center gap-4">
          ...
          <div class="min-w-0">
            <p class="break-words font-semibold text-ink">{{ offer.seller.shop_name }}</p>
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
          ...
          <span
            class="inline-flex justify-center rounded-2xl px-4 py-3 text-sm font-semibold"
